...
%% HERITAGE
%% =====================
UTILISATEUR ||--|| PATIENT : "est"
UTILISATEUR ||--|| MEDECIN : "est"

%% =====================
%% ASSOCIATIONS
%% =====================

MEDECIN ||--|{ CRENEAU : "propose"

PATIENT ||--|{ RENDEZVOUS : "reserve"
MEDECIN ||--|{ RENDEZVOUS : "concerne"

RENDEZVOUS ||--o| CRENEAU : "utilise"

PATIENT ||--|{ DOCUMENT_MEDICAL : "possede"
MEDECIN ||--|{ DOCUMENT_MEDICAL : "depote"

PATIENT ||--|{ AVIS : "laisse"
MEDECIN ||--|{ AVIS : "recoit"

RENDEZVOUS ||--|{ NOTIFICATION : "declenche"
```
